...
[![CI](https://github.com/GhouI/winreach-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/GhouI/winreach-mcp/actions/workflows/ci.yml)
...
- Use a long random `WINREACH_TOKEN`.
- Keep `WINREACH_HOST=127.0.0.1` unless you have a trusted network path or are using tunnel mode.
- Do not expose WinReach directly to the public internet on a raw port.

...
Pendragon executes arbitrary PowerShell after bearer-token authentication. A compromised token is equivalent to command execution as the user running the server.
...
- Rotate `PENDRAGON_TOKEN` regularly.
